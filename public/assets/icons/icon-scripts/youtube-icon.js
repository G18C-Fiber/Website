document.addEventListener("DOMContentLoaded", function () {
    const youtubeIcon = document.querySelector('.social-icon.youtube-icon');

    // Retrieve the href value from a data attribute
    const href = youtubeIcon.dataset.href || "#";
